...
const updateUserPassword = (req, res) => {
  ...
  params.put.Key["email"] = userEmail;
  params.put.ExpressionAttributeNames["#dataType"] = "password";
  params.put.ExpressionAttributeValues[":dataValue"] = newPassword;
  documentClient.update(params.put, (error, results) => {
    if (error) throw error;
    res.status(200);
  });
};
